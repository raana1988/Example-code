<%@ Page Title="وب سایت رسمی شرکت شیمیایی کمیکس -محصولات" Language="C#" MasterPageFile="~/masterFarsi.Master" AutoEventWireup="true" CodeBehind="rmp_farsi.aspx.cs" Inherits="PRojectCH.rmpFarsi" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <ItemTemplate>
     ...
     <td id="Td1"  valign="top" align="center" style=' width:220px;height:235px;vertical-align:middle;'  runat="server">
        ...
        <td style="padding-right:35px;">&nbsp&nbsp&nbsp</td>
    </ItemTemplate>
    <EmptyItemTemplate>
        <td />
    </EmptyItemTemplate>
    <EmptyDataTemplate>
        <h3 style="font-family:'B Yekan';color:#860505;text-align:center">اطلاعاتی وارد نشده است </h3>
           ...
           <asp:sqldatasource id="SqlDataSource1" runat="server"
            ...
            <SelectParameters>
                <asp:Parameter DefaultValue="2" Name="TypePr" Type="Byte" />
            </SelectParameters>
           </asp:sqldatasource>
